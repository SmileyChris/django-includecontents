...
!!! note "Template Engine Support"
    The `{% wrapif %}` tag is currently only available in Django templates. For Jinja2, you can achieve similar functionality with conditional macros or template inheritance.
