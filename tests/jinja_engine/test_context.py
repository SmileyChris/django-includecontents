...
def test_context_isolation_disabled() -> None:
    ...
    template = env.from_string('{% includecontents "debug" %}Test{% endincludecontents %}')
...
def test_context_isolation_enabled_by_default() -> None:
    ...
    template = env.from_string('{% includecontents "debug" message="Hello" %}Test{% endincludecontents %}')
...
def test_props_override_preserved_keys() -> None:
    ...
    template = env.from_string('{% includecontents "user" user="component_user" %}Test{% endincludecontents %}')
