...
from includecontents.shared.typed_props import component, get_props_class, clear_registry
...
class TestDataclassValidation:
    ...
    def test_required_and_optional_fields(self):
        ...
        # All fields provided
        result = validate_props(MixedProps, {
            'title': 'Test',
            'count': 5,
            'description': 'A test'
        })
...
class TestCustomValidation:
    ...
    def test_multiple_validation_errors(self):
        ...
        # Valid values
        result = validate_props(MultiValidateProps, {
            'username': 'alice',
        ...
        with pytest.raises(TemplateSyntaxError) as exc_info:
            validate_props(MultiValidateProps, {
                'username': 'al',
                'password': 'short'
            })
...
class TestInheritance:
    ...
    def test_dataclass_inheritance(self):
        ...
        result = validate_props(ExtendedProps, {
            'title': 'Test',
            'category': 'Important'
        })
        assert result['title'] == 'Test'
