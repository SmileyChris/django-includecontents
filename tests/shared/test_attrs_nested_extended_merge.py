...
class TestNestedExtendedAttrsMerging:
    ...
    def test_nested_extended_attrs_preserved_with_fallbacks(self):
        ...
        assert attrs._nested_attrs['title']._conditional_modifiers == {'class': {'text-red': True}}
        ...
        assert result._nested_attrs['title']._conditional_modifiers == {'class': {'text-red': True}}
    ...
    def test_nested_extended_attrs_with_conflicting_fallbacks(self):
        ...
        assert result._nested_attrs['title']._conditional_modifiers == {'class': {'active': True}}
    ...
    def test_empty_fallbacks_preserve_nested_extended(self):
        ...
        assert result._nested_attrs['form']._conditional_modifiers == {'class': {'invalid': True}}
